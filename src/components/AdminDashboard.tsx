...
const AdminDashboard = ({
  ...
  return (
    <div className="min-h-screen bg-[#070b13] bg-stadium-grid text-white pb-16 relative overflow-hidden transition-all duration-300">
      ...
      <main className="container mx-auto px-6 py-10 max-w-6xl relative z-10">
        ...
        {/* Control Banner */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-950 via-slate-900/90 to-slate-950 p-8 text-white border border-white/10 dark:border-white/5 shadow-2xl mb-10">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-2.5">
                ...
                <h1 className="text-3xl font-black uppercase tracking-wider bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
                  Control Room
                </h1>
              </div>
              ...
              <div className="flex space-x-2 pt-1">
                ...
                <Badge className="bg-slate-900 border border-amber-500/30 text-amber-400 font-extrabold px-3 py-1">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button onClick={onExportData} variant="outline" className="rounded-xl border-white/10 bg-slate-900/60 hover:bg-slate-800 text-slate-200 font-bold text-xs flex items-center gap-1.5">
        ...
        <Tabs defaultValue="overview" className="space-y-8">
          <TabsList className="flex flex-wrap md:grid w-full grid-cols-5 bg-slate-950/60 p-1 rounded-2xl h-auto gap-1 border border-white/5 backdrop-blur-md">
            <TabsTrigger value="overview" className="rounded-xl text-xs font-black flex-1 py-3 text-slate-400 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300">
              Overview
            </TabsTrigger>
            <TabsTrigger value="players" className="rounded-xl text-xs font-black flex-1 py-3 text-slate-400 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300">
              Players
            </TabsTrigger>
            <TabsTrigger value="fixtures" className="rounded-xl text-xs font-black flex-1 py-3 text-slate-400 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300">
              Schedule
            </TabsTrigger>
            <TabsTrigger value="results" className="rounded-xl text-xs font-black flex-1 py-3 text-slate-400 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300">
              Scoring
            </TabsTrigger>
            <TabsTrigger value="settings" className="rounded-xl text-xs font-black flex-1 py-3 text-slate-400 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300">
              Config
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="overview" className="space-y-6 outline-none">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl p-5 hover:border-primary/30 transition-all hover:scale-[1.02] duration-300">
                <CardContent className="p-0 flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-3xl font-black text-white">{players.length}</p>
                    <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Players Registered</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-950/50 text-primary border border-white/5">
              ...
              <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl p-5 hover:border-primary/30 transition-all hover:scale-[1.02] duration-300">
                <CardContent className="p-0 flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Completed Matches</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-950/50 text-emerald-400 border border-white/5">
              ...
              <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl p-5 hover:border-primary/30 transition-all hover:scale-[1.02] duration-300">
                <CardContent className="p-0 flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-3xl font-black text-white">{upcomingMatches}</p>
                    <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Upcoming Fixtures</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-950/50 text-secondary border border-white/5">
              ...
              <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl p-5 hover:border-primary/30 transition-all hover:scale-[1.02] duration-300">
                <CardContent className="p-0 flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-xl font-black text-white truncate pt-1">{tournament.currentRound}</p>
                    <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Current Stage</p>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-950/50 text-amber-400 border border-white/5">
            ...
            <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl shadow-xl overflow-hidden">
              <CardHeader className="border-b border-white/10 bg-slate-950/45">
                ...
                <CardDescription className="text-slate-400">Live standings overview based on points</CardDescription>
              </CardHeader>
              <CardContent className="p-0 divide-y divide-white/5">
                {players
                  ...
                  .slice(0, 5)
                  .map((player, index) => (
                    <div key={player.id} className="flex items-center justify-between p-4 px-6 hover:bg-white/5 transition-all duration-200">
                      <div className="flex items-center space-x-4">
                        <div className={`h-7 w-7 rounded-lg flex items-center justify-center font-bold text-xs text-slate-950 shadow-inner ${
                          index === 0 
                            ? 'bg-gradient-to-br from-amber-300 via-amber-400 to-amber-600 text-slate-950 shadow-amber-400/50' 
                            : index === 1 
                            ? 'bg-gradient-to-br from-slate-200 to-slate-400 text-slate-950 shadow-slate-300/40' 
                            : index === 2 
                        ...
                        <div>
                          <p className="font-extrabold text-white text-sm sm:text-base">{player.name}</p>
                          <p className="text-xs text-slate-400">{player.currentTeam}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="font-black text-sm text-primary">{player.stats.points} pts</p>
                        <p className="text-[10px] text-slate-400 font-semibold">{player.stats.wins}W - {player.stats.losses}L</p>
                      </div>
                    </div>
                  ))}
              </CardContent>
          ...
          <TabsContent value="players" className="space-y-6 outline-none">
            <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl shadow-xl overflow-hidden">
              <CardHeader className="border-b border-white/10 bg-slate-950/45">
                ...
                <CardDescription className="text-slate-400">Add a new competitor into the Kawerify Tech tournament registry.</CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <form onSubmit={onAddPlayer} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div className="space-y-1.5">
                      <Label htmlFor="reg-name" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Player Name *</Label>
                      <Input
                        id="reg-name"
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="reg-team" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Represented FIFA Team *</Label>
                      <Input
                        id="reg-team"
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="reg-img" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Profile Image URL</Label>
                      <Input
                        id="reg-img"
            ...
            <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl shadow-xl overflow-hidden">
              <CardHeader className="border-b border-white/10 bg-slate-950/45">
                <CardTitle className="text-lg font-black uppercase tracking-wider text-white">Registered Competitors ({players.length})</CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {players.map((player) => (
                    <Card key={player.id} className="bg-slate-950/40 border border-white/5 rounded-xl hover:-translate-y-1 hover:border-primary/30 transition-all duration-300 relative overflow-hidden">
          ...
          <TabsContent value="fixtures" className="space-y-6 outline-none">
            <Card className="bg-slate-900/60 dark:bg-slate-950/45 backdrop-blur-md border border-white/10 dark:border-white/5 rounded-2xl shadow-xl overflow-hidden">
              <CardHeader className="border-b border-white/10 bg-slate-950/45">
                ...
                <CardDescription className="text-slate-400">Manually configure and add a matchday fixture to the calendar.</CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <Select value={newMatch.player1Id} onValueChange={(value) => {
                        ...
                        <SelectContent className="bg-slate-900 border-white/10 text-slate-200">
                          {players.map((player) => (
                            <SelectItem key={player.id} value={player.id} className="focus:bg-slate-800 focus:text-white">
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="match-date" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Match Date</Label>
                      <Input
                        id="match-date"
                        type="date"
                        value={newMatch.date}
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="match-time" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Kick-Off Time</Label>
                      <Input
                        id="match-time"
                        type="time"
                        value={newMatch.time}
                    ...
                    <div className="space-y-1.5">
                      <Label className="text-slate-300 text-xs font-bold uppercase tracking-wider">Stage / Match Type</Label>
                      <Select value={newMatch.matchType} onValueChange={(value: Match['matchType']) => setNewMatch({...newMatch, matchType: value})}>
                        <SelectTrigger className="rounded-xl border-white/10 bg-slate-950/40 text-slate-200">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-slate-900 border-white/10 text-slate-200">
                          <SelectItem value="regular" className="focus:bg-slate-800 focus:text-white">Regular Season</SelectItem>
                          <SelectItem value="quarter-final" className="focus:bg-slate-800 focus:text-white">Quarter Final</SelectItem>
                          <SelectItem value="semi-final" className="focus:bg-slate-800 focus:text-white">Semi Final</SelectItem>
                          <SelectItem value="final" className="focus:bg-slate-800 focus:text-white">Final Match</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>

                    <div className="space-y-1.5">
                      <Label htmlFor="match-week" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Week Number</Label>
                      <Input
                        id="match-week"
                        type="number"
                        min="1"
