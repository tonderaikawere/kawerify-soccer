...
const GameLoader = ({ onComplete }: { onComplete: () => void }) => {
  ...
  const loadingTips = [
    "🎮 PRO TIP: BLAMING THE DRAGGING ANALOG STICK ADDS +10 TO YOUR EMOTIONAL DAMAGE STATS.",
    "⚽ RESETTING LOCAL EXCUSES: 'THE DUST IN THE PORT' OR 'MY HANDS ARE SWEATY' OR 'THE SCRIPT IS REAL'...",
    "🔥 SEEDING THE LEADERBOARDS... YES, EVEN THOSE WITH 0 POINTS.",
    "🏆 GENERATING REAL BRAGGING RIGHTS... PREPARE YOUR POST-MATCH TRASH TALK.",
    "⚡ REMINDER: THROWING THE CONTROLLER AT KO MTHOMBENI DOES NOT REVERSE THE OFFSIDE CALL.",
    "🎮 SKILL MANUAL: PASSING IS FASTER THAN DRIBBLING, BUT SKILLING MAKES THE MONTAGES COOLER."
  ];
