...
const Leaderboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070b13] pb-16 transition-colors duration-300">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#030712] via-[#0a1122] to-[#030712] border-b border-white/5 py-16 px-6 mb-12">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent opacity-75 pointer-events-none" />
        <div className="absolute top-12 left-10 w-72 h-72 bg-emerald-500/5 rounded-full blur-[100px] animate-radial-pulse pointer-events-none" />
        <div className="absolute bottom-6 right-20 w-80 h-80 bg-blue-500/5 rounded-full blur-[120px] pointer-events-none animate-radial-pulse" style={{ animationDelay: '2s' }} />

        <div className="max-w-5xl mx-auto text-center relative z-10 space-y-6">
          <div className="inline-flex items-center space-x-2 bg-slate-900/80 border border-white/10 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest text-emerald-400 shadow-lg">
            <span>⚽ Tournament Active</span>
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping inline-block" />
          </div>
          
          <h1 className="text-4xl sm:text-6xl font-black tracking-wider text-white uppercase leading-none">
            Kawerify <span className="bg-gradient-to-r from-primary to-emerald-400 bg-clip-text text-transparent">Tech Cup</span>
          </h1>
          
          <p className="text-slate-400 text-xs sm:text-sm max-w-xl mx-auto font-bold uppercase tracking-wider leading-relaxed">
            Welcome to the home of ultimate competitive soccer. Live standings, game analytics, match fixtures schedules, and player registries.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <div className="bg-slate-950/80 border border-white/5 px-6 py-2.5 rounded-xl text-center min-w-[110px] shadow-lg">
              <span className="block text-[9px] text-slate-500 font-bold uppercase tracking-widest">Season</span>
              <span className="text-sm font-black text-white">{tournament.season}</span>
            </div>
            <div className="bg-slate-950/80 border border-white/5 px-6 py-2.5 rounded-xl text-center min-w-[110px] shadow-lg">
              <span className="block text-[9px] text-slate-500 font-bold uppercase tracking-widest">Current Week</span>
              <span className="text-sm font-black text-amber-400">Week {tournament.currentWeek}</span>
            </div>
            <div className="bg-slate-950/80 border border-white/5 px-6 py-2.5 rounded-xl text-center min-w-[110px] shadow-lg">
              <span className="block text-[9px] text-slate-500 font-bold uppercase tracking-widest">Stage</span>
      ...
      <div className="container mx-auto px-4 relative z-20 max-w-5xl">
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-end justify-center gap-6 max-w-4xl mx-auto">
              ...
              {topThree[1] && (
                <div className="w-full md:w-1/3 order-2 md:order-1 flex flex-col">
                  <div className="relative group flex-1 rounded-2xl bg-gradient-to-b from-slate-900/60 to-slate-950/20 border border-white/10 p-6 text-center hover:border-white/20 shadow-xl transition-all duration-350 hover:-translate-y-2 flex flex-col justify-between min-h-[300px]">
                    ...
                    <div>
                      ...
                      <h3 className="font-extrabold text-sm text-slate-900 dark:text-white truncate">{topThree[1].name}</h3>
                      <p className="text-xs text-primary font-bold truncate mt-0.5">{topThree[1].currentTeam}</p>
                    </div>
                    <div className="mt-4">
                      {getRankBadge(2)}
                      <div className="mt-4 pt-3.5 border-t border-white/5 flex justify-around text-xs">
                        <div>
                          <span className="block font-black text-slate-800 dark:text-slate-100">{topThree[1].stats.points}</span>
                        ...
                        <div>
                          ...
                          <span className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">WR</span>
                        </div>
                        <div>
                          <span className="block font-black text-blue-500">{topThree[1].stats.goalsFor}</span>
                          <span className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">GF</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="w-full md:w-1/3 order-1 md:order-2 flex flex-col md:mb-4">
                  <div className="relative group flex-1 rounded-2xl bg-gradient-to-b from-amber-500/20 via-amber-600/5 to-transparent border-2 border-amber-500/40 p-7 text-center shadow-2xl shadow-amber-500/10 hover:border-amber-400 transition-all duration-350 hover:-translate-y-3 flex flex-col justify-between min-h-[340px]">
                    ...
                    <div className="pt-2">
                      ...
                      <h3 className="font-black text-base text-slate-950 dark:text-white truncate">{topThree[0].name}</h3>
                      <p className="text-xs text-primary font-black truncate mt-0.5">{topThree[0].currentTeam}</p>
                    </div>
                    <div className="mt-4">
                      {getRankBadge(1)}
              ...
              {topThree[2] && (
                <div className="w-full md:w-1/3 order-3 md:order-3 flex flex-col">
                  <div className="relative group flex-1 rounded-2xl bg-gradient-to-b from-amber-950/15 to-transparent border border-amber-800/25 p-6 text-center hover:border-amber-700/40 shadow-xl transition-all duration-350 hover:-translate-y-2 flex flex-col justify-between min-h-[280px]">
                    <div className="absolute top-4 right-4 text-amber-700 font-black text-sm">{getRankIcon(3)}</div>
                    <div>
                      ...
                      <h3 className="font-extrabold text-sm text-slate-900 dark:text-white truncate">{topThree[2].name}</h3>
                      <p className="text-xs text-primary font-bold truncate mt-0.5">{topThree[2].currentTeam}</p>
                    </div>
                    <div className="mt-4">
                      {getRankBadge(3)}
                      <div className="mt-4 pt-3.5 border-t border-white/5 flex justify-around text-xs">
                        <div>
                          <span className="block font-black text-slate-800 dark:text-slate-100">{topThree[2].stats.points}</span>
                          <span className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">PTS</span>
                        </div>
                        <div>
        ...
        <Card className="glass-panel border-white/10 shadow-2xl overflow-hidden rounded-2xl">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center space-x-6">
                <div className="bg-slate-900 border border-white/5 px-4 py-2 rounded-xl text-center">
                  <span className="block text-[9px] text-slate-400 font-bold uppercase tracking-widest">Stage</span>
                  <span className="text-sm font-black text-emerald-400">{tournament.currentRound}</span>
                </div>
              </div>
            </div>
          ...
          <CardContent className="p-0">
            {/* Headers row (desktop) */}
            <div className="hidden md:grid grid-cols-12 gap-4 px-8 py-4 border-b border-white/5 bg-slate-950/20 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center items-center">
            ...
            <div className="divide-y divide-white/5">
              {sortedPlayers.map((player, index) => {
                ...
                return (
                  <div
                    key={player.id}
                    className="relative group grid grid-cols-1 md:grid-cols-12 gap-4 px-6 md:px-8 py-5 items-center text-center transition-all duration-300 hover:bg-slate-500/5"
                  >
                    {/* Rank */}
                    ...
                    <div className="col-span-4 text-left flex items-center space-x-4">
                      ...
                      <div className="truncate">
                        <h4 className="font-extrabold text-slate-900 dark:text-slate-100 group-hover:text-primary transition-colors text-sm truncate uppercase">
                          {player.name}
                        </h4>
                    ...
                    <div className="grid grid-cols-5 md:contents gap-2 mt-4 md:mt-0 text-slate-800 dark:text-slate-200">
                      <div className="flex flex-col md:block col-span-1">
                        <span className="md:hidden text-[9px] text-slate-500 uppercase font-black tracking-widest">Played</span>
                        <span className="font-bold text-sm">{player.stats.matchesPlayed}</span>
                      </div>
                      <div className="flex flex-col md:block col-span-1">
                        <span className="md:hidden text-[9px] text-emerald-500 uppercase font-black tracking-widest">Wins</span>
                        <span className="font-bold text-emerald-500 text-sm">{player.stats.wins}</span>
                      </div>
                      <div className="flex flex-col md:block col-span-1">
                        <span className="md:hidden text-[9px] text-rose-500 uppercase font-black tracking-widest">Losses</span>
                        <span className="font-bold text-rose-500 text-sm">{player.stats.losses}</span>
                      </div>
                      <div className="flex flex-col md:block col-span-1">
                        <span className="md:hidden text-[9px] text-slate-500 uppercase font-black tracking-widest">GF-GA</span>
                        <span className="text-slate-500 font-bold text-xs">{player.stats.goalsFor}:{player.stats.goalsAgainst}</span>
                      </div>
                      <div className="flex flex-col md:block col-span-1">
                        <span className="md:hidden text-[9px] text-slate-500 uppercase font-black tracking-widest">GD</span>
                    ...
                    <div className="col-span-1 flex flex-col items-center justify-center mt-3 md:mt-0">
                      <span className="md:hidden text-[9px] text-slate-500 uppercase font-black tracking-widest mb-1">Win Rate</span>
                      <div className="w-full max-w-[80px] text-center">
                        <span className="text-[11px] font-black text-slate-700 dark:text-slate-300">{winRate}%</span>
                        <Progress value={winRate} className="h-1 mt-1 bg-muted/60" />
                      </div>
                    </div>

                    {/* Points */}
                    <div className="col-span-1 text-center md:text-right pr-2 mt-3 md:mt-0 flex flex-col md:block">
                      <span className="md:hidden text-[9px] text-slate-500 uppercase font-black tracking-widest">Points</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-10">
          <Card className="glass-card overflow-hidden relative group">
            ...
            <CardContent className="p-6">
              <span className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Tournament Leader</span>
          ...
          <Card className="glass-card overflow-hidden relative group">
            ...
            <CardContent className="p-6">
              <span className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Golden Boot Leader</span>
              <h3 className="text-lg font-black text-slate-900 dark:text-white mt-1">
                {Math.max(...sortedPlayers.map(p => p.stats.goalsFor), 0)} goals
              </h3>
              <p className="text-xs text-muted-foreground mt-0.5 font-bold uppercase tracking-wider text-[10px]">Highest scoring stats</p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card overflow-hidden relative group">
            ...
            <CardContent className="p-6">
              <span className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Matches Logged</span>
              <h3 className="text-lg font-black text-slate-900 dark:text-white mt-1">
                {sortedPlayers.reduce((sum, p) => sum + p.stats.matchesPlayed, 0) / 2} matches
              </h3>
              <p className="text-xs text-muted-foreground mt-0.5 font-bold uppercase tracking-wider text-[10px]">Across all rounds</p>
            </CardContent>
          </Card>
        </div>
